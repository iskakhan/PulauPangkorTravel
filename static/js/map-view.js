import { DEFAULT_CENTER, PANGKOR_BOUNDS } from './config.js';
import { buildLocationPopupHtml, createLocationPinElement } from './components/location-pin.js';
import { createUserMarkerElement } from './components/user-marker.js';
import {
